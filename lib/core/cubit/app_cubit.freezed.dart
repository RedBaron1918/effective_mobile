...
abstract class $AppStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({BottomBarTab currentTab});
}
...
class _$AppStateImpl extends _AppState with DiagnosticableTreeMixin {
  const _$AppStateImpl({this.currentTab = BottomBarTab.airlines}) : super._();
...
abstract class _AppState extends AppState {
  const factory _AppState({final BottomBarTab currentTab}) = _$AppStateImpl;
